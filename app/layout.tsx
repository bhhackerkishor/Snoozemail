...
export const metadata: Metadata = {
  ...
  description:
    "SnoozeMail lets you schedule reminders for important emails. Stay on top of your inbox, always.",
  keywords: [
    "email reminders",
    "email snooze",
    "SnoozeMail",
  ...
  openGraph: {
    title: "SnoozeMail",
    description:
      "SnoozeMail helps you remember emails at the right time. Perfect for busy professionals.",

    ...
    <div className="p-6 sm:p-10 max-w-5xl mx-auto space-y-6">
      ...
      <Card>
        ...
        <CardContent className="text-sm text-gray-600 dark:text-gray-300">
          These are emails you&apos;ve forwarded to{" "}
          <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">
            2min@snoozemail.app
          </code>{" "}
          or similar addresses. We&apos;ll send them back to your inbox at the
          exact time you requested.
        </CardContent>
      </Card>
      ...
      {emails.length > 0 ? (
        <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
          {emails.map((email, idx) => (
            <Card
              key={idx}
              className="border-sky-200 dark:border-sky-800 hover:shadow-lg transition-shadow"
            >
              <CardHeader>

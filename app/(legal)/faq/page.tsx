  ...
  General: [
    {
      ...
      answer:
        "You can request a specialized cleaning for post-renovation. Our team uses industrial-grade equipment for deep cleaning.",
    },
    {
      question: "Do I get a discount if I'm a frequent customer?",
      answer:
        "Yes! We offer loyalty discounts for monthly and yearly subscribers.",
    },
  ],
  "Trust & Safety": [
    {
      ...
      answer:
        "Absolutely. We do not read, store, or share your email contents. Everything is encrypted and deleted after processing.",
    },
  ],
  Services: [
    {
      ...
      answer:
        "Currently we support emails only, but WhatsApp integration is on our roadmap.",
    },
  ],
  Billing: [
    {
      ...
      answer:
        "Refunds are only available if the subscription was not used. Contact support within 7 days.",
    },
  ],
  "About SnoozeMail": [
    {
      ...
      answer:
        "SnoozeMail lets you forward any email to an address like 2min@snoozemail.in, and we'll resend it to you after that time — like a personal reminder bot.",
    },
    {
      question: "How do I use it?",
      answer:
        "Just forward any email to us. We'll parse the time and send it back to you after the delay.",
    },
    {
      question: "What formats are supported?",
      answer:
        "- 2min@snoozemail.in → in 2 minutes\n- 5h@snoozemail.in → in 5 hours\n- tomorrow@snoozemail.in → next day same time\n- nextweek@snoozemail.in → 7 days later\nWe also support snoozedemos+2min@gmail.com in the demo version.",
    },
    {
      question: "Do you read or store my emails?",
      answer:
        "No. We store the message temporarily just to send it back to you, then delete it. You can read our Privacy Policy for details.",
    },
    {
      question: "Do I need an account?",
      answer:
        "You can use it without signing up in demo mode. But to manage reminders, see history, and upgrade plans, we recommend signing up.",
    },
    {
      question: "What are the plan limits?",
      answer:
        "- Free: 10 reminders per month\n- Pro: 100 reminders\n- Team: Unlimited reminders + collaboration",
    },
    {
      question: "Can I unsubscribe from reminders?",
      answer:
        "Yes. Just click the unsubscribe link in any reminder email or manage reminders from your dashboard.",
    },
    {
      question: "Who built this?",
      answer:
        "SnoozeMail is an indie project by kishore kumar. We'd love your feedback.",
    },
  ],
};
          ...
          >
            ...
            <Accordion type="multiple" className="w-full space-y-2">
              {questions.map((item, index) => (
                <motion.div key={index} whileHover={{ scale: 1.005 }}>
                  <AccordionItem
